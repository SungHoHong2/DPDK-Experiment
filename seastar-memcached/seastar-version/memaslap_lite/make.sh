...
-DHAVE_CONFIG_H -I. -fvisibility=hidden  -g -O2 -MT clients/memaslap.o -MD -MP -MF $depbase.Tpo -c -o clients/memaslap.o clients/memaslap.cc
mv -f $depbase.Tpo $depbase.Po

depbase=`echo clients/ms_conn.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`
$GCC_INSTALL $SEASTAR_INSTALL
-DHAVE_CONFIG_H -I.  -fvisibility=hidden  -g -O2 -MT clients/ms_conn.o -MD -MP -MF $depbase.Tpo -c -o clients/ms_conn.o clients/ms_conn.cc
mv -f $depbase.Tpo $depbase.Po

depbase=`echo clients/ms_setting.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`
$GCC_INSTALL $SEASTAR_INSTALL
-DHAVE_CONFIG_H -I.   -fvisibility=hidden  -g -O2 -MT clients/ms_setting.o -MD -MP -MF $depbase.Tpo -c -o clients/ms_setting.o clients/ms_setting.cc
mv -f $depbase.Tpo $depbase.Po

depbase=`echo clients/ms_sigsegv.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`
$GCC_INSTALL $SEASTAR_INSTALL
-DHAVE_CONFIG_H -I.  -fvisibility=hidden  -g -O2 -MT clients/ms_sigsegv.o -MD -MP -MF $depbase.Tpo -c -o clients/ms_sigsegv.o clients/ms_sigsegv.cc
mv -f $depbase.Tpo $depbase.Po

depbase=`echo clients/ms_stats.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`
$GCC_INSTALL  $SEASTAR_INSTALL
-DHAVE_CONFIG_H -I.   -fvisibility=hidden -fPIC -g -O2 -MT clients/ms_stats.o -MD -MP -MF $depbase.Tpo -c -o clients/ms_stats.o clients/ms_stats.cc
mv -f $depbase.Tpo $depbase.Po
